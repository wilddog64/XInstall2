...
namespace XInstall.CustomTestActions {
    ...
    public class PerfMonCounterCategory {
        ...
        private void ProcessCounterCategoryNode( XmlNode ActionNode ) {
            ...
            XmlNode CounterCategoryEnableNode = CounterCategoryAttribs.GetNamedItem( "Enable" );
            ...
            bool Enable = true;
            if ( CounterCategoryEnableNode != null )
                Enable = XmlConvert.ToBoolean( CounterCategoryEnableNode.Value );
