    ...
    public class MSI : ActionElement, IAction {
	    ...
	    public string PackageLocation {
		    ...
		    set {
			    ...
			    base.LogItWithTimeStamp( String.Format( @"MSI package located at: {0}", this._PackageLocation ) );
		    }
	    }
	    ...
	    public string InstallLogFile {
		    ...
		    set {
			    ...
			    if ( this._InstallLogFileName.ToLower().Equals("auto") )
				    this._InstallLogFileName = Path.ChangeExtension( Path.GetFileName( this.PackageLocation ), "log" );
		    }
	    }
	    ...
	    public override void ParseActionElement() {
		    ...
		    base.LogItWithTimeStamp( String.Format( "Command line parameters {0}", this._InstallCommands.ToString() ) );
