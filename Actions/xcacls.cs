    ...
    public class xcacls : ExternalPrg {
	    ...
	    public string ProgramPath {
		    ...
		    set {
              ...
              throw new DirectoryNotFoundException( String.Format( @"Cannot find directory: {0}",
                    this._ProgramPath ) );
				    }
			    }
		    }
		    ...
		    set {
			    ...
			    case _ContainerType.FILE:
				    if ( !File.Exists( this._Container ) )
					    throw new FileNotFoundException( String.Format( "cannot find file: {0}",
							       this._Container ) );
				    break;
	    ...
	    public string Permissions {
		    set {
			    ...
			    default:
					...
					String.Format( "unknown permission arguments {0}", value), "Permissions");
			    }
		    }
	    }
