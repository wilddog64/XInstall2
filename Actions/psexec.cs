...
namespace XInstall.Core.Actions {
    ...
    public class psexec : ExternalPrg {
	    ...
	    protected override string GetArguments() {
		    ...
		    bool LengthOK = this.ComputerName.Length == 0 || this.MachineListFile.Length == 0;
		    if ( !LengthOK ) {
		    ...
		    bool UsrPwdOK = (this.UserName.Length > 0 && this.Password.Length == 0) || (this.Password.Length > 0 && this.UserName.Length == 0 );
	    ...
	    public void OnProcessCompleted( object Sender, ProcessCompletedEventArgs e ) {
		    ...
		    if ( e.ReturnCode == 0 ) {
			    ...
			    Message = String.Format( "{0}: execute command against {1}, {2} failed.", this.ObjectName, this.ComputerName, this.Cmd2Exec );
		    }
