...
#region private property method variables
    ...
    private ROBOCOPY_EXIT_CODE _enumRobocopyExitCode = ROBOCOPY_EXIT_CODE.ROBOCOPY_COPY_SUCCESSFULL;
    ...
    public string SourceDirectory {
      ...
      set {
        if ( value != null ) {
          ...
          base.LogItWithTimeStamp( String.Format( "robocopy: copy from {0}",
                this._strSourceDir ) );
        }
        else {
